...
class IncidentDetailsUrlTestCase(TestCase):
    ...
    def test_pp_details_url_empty_string(self):
        detail_url = ""
        incident = IncidentFactory.build(source=self.source_no_base_url, details_url=detail_url)
    ...
    def test_pp_details_url_has_base_url_empty_string(self):
        detail_url = ""
        incident = IncidentFactory.build(source=self.source_has_base_url, details_url=detail_url)
        self.assertEqual(incident.pp_details_url(), detail_url)
