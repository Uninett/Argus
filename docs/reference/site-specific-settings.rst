...
This, in effect, bypasses the use of a task queue.

Turn on a database backed queue by changing to::
...
In addition to this you will need to run a database worker, see `task_queue`
