...
class NotificationProfileAdmin(admin.ModelAdmin):
    list_display = ("get_str", "get_filters", "get_destinations", "active")
    list_filter = (
        "active",
    ...
    def get_destinations(self, notification_profile: NotificationProfile):
        return format_html_join(
            "", "<div>{}</div>", ((destination,) for destination in notification_profile.destinations.all())
        )
