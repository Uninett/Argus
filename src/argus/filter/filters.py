...
from .queryset_filterwrapper import IncidentQuerySetFilterWrapper
...
class IncidentFilter(filters.FilterSet):
    ...
    def incident_filter(cls, queryset, name, value):
        ...
        if name == "filter_pk":
            return IncidentQuerySetFilterWrapper.incidents_by_filter_pk(queryset, value)
        if name == "notificationprofile_pk":
            return IncidentQuerySetFilterWrapper.incidents_by_notificationprofile_pk(queryset, value)
        return queryset
