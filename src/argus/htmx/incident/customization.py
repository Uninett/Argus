...
_BUILTIN_COLUMN_LIST = [
    IncidentTableColumn(
        "row_select",
        "Selected",
        "htmx/incident/_incident_checkbox.html",
        "htmx/incident/_incident_list_select_all_checkbox.html",
    ),
    IncidentTableColumn("id", "ID", "htmx/incident/_incident_pk.html"),
    IncidentTableColumn(
        "start_time",
        "Timestamp",
        "htmx/incident/_incident_start_time.html",
        "htmx/incident/_incident_start_time_header.html",
    ),
    IncidentTableColumn("status", "Status", "htmx/incident/_incident_status.html"),
    IncidentTableColumn("level", "Severity level", "htmx/incident/_incident_level.html"),
    IncidentTableColumn("source", "Source", "htmx/incident/_incident_source.html"),
    IncidentTableColumn("description", "Description", "htmx/incident/_incident_description.html"),
    IncidentTableColumn("ack", "Ack", "htmx/incident/_incident_ack.html"),
    IncidentTableColumn("combined_status", "Status", "htmx/incident/_incident_combined_status.html"),
    IncidentTableColumn("ticket", "Ticket", "htmx/incident/_incident_ticket.html"),
    IncidentTableColumn("links", "Actions", "htmx/incident/_incident_actions.html"),
]
