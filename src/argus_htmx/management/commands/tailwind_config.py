...
to dynamically build a tailwind.config.js. The template should contain a
'{{ daisyuithemes }}' section without square brackets that will be popuplated by the 
...
"""
    ...
    DEFAULT_TARGET = "src/argus_htmx/tailwindtheme/tailwind.config.base.js"
